            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Skills</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.about-skill.add') }}" method="POST">
                                    @csrf
                                    <div id="add_skills" class="p-8 border-primary border-1" style="border-style: dotted;">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <label for="txt_title_ar">Icon<span class="text-danger">*</span></label>
                                                <textarea class="form-control"
                                                       placeholder="Enter SVG Class"
                                                       name="icon" required id="txt_title_ar" rows="2"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="txt_amount">Amount<span class="text-danger">*</span></label>
                                                <input type="number" class="form-control"
                                                       placeholder="Enter amount in integer"
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="{{ route('admin.layout.about-skill.edit') }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       name="icon" required id="txt_title_ar" />
                                <div class="d-md-none mb-2"></div>
                            </div>
                            <div class="form-group">
                                <label for="txt_amount">Amount (%)<span class="text-danger">*</span></label>
