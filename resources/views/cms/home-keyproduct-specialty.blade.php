...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/home-keyproduct-specialty.js') }}"></script>
@endsection
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Main Product Specialties</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">Main Product Specialties</h3>
                            </div>
                            <!--begin::Form-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.home-keyproduct-specialty.add') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_specialties">
                                    ...
                                    <tr>
                                        ...
                                        <th title="Field #3">Icon Class</th>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="{{ route('admin.layout.home-keyproduct-specialty.edit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="txt_icon">Icon Class
                                    <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="txt_icon" name="icon"
                                    placeholder="Icon Class" required
                                    rows="2"></textarea>
                            </div>
                            <div class="form-group">
