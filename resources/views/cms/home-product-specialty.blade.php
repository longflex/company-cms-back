...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/home-product-specialty.js') }}"></script>
@endsection
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Product Specialties</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">Product Specialties</h3>
                            </div>
                            <!--begin::Form-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.home-product-specialty.add') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Product Specialty</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
                    <form class="form" action="{{ route('admin.layout.home-product-specialty.edit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
