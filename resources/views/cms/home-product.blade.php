...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/home-product.js') }}"></script>
@endsection
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.home-product.add') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="{{ route('admin.layout.home-product.edit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
